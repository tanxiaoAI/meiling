export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do 媒灵",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do 媒灵 foi baixada. Você gostaria de instalá-la e reiniciar?",
