export const dict = {
  ...
  "command.review.toggle": "Toggle reader",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by 媒灵",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in 媒灵.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "媒灵 Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.opencodeZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.opencodeZen.visit.prefix": "Visit ",
  "provider.connect.opencodeZen.visit.link": "官网暂未配置",
  "provider.connect.opencodeZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in 媒灵.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in 媒灵.",
  ...
  "dialog.server.description": "Switch which 媒灵 server this app connects to.",
  ...
  "toast.update.description": "A new version of 媒灵 ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the 媒灵 team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, 媒灵 does not support MCP authentication yet.',
  ...
  "session.tab.review": "Reading now",
  "session.tab.context": "Context",
  "session.panel.reviewAndFiles": "File workspace",
  ...
  "session.files.selectToOpen": "Choose a file from the manager to start reading",
  "session.files.all": "File manager",
  ...
  "sidebar.gettingStarted.line1": "媒灵 includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the 媒灵 server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for 媒灵",
  ...
  "settings.general.row.appearance.description": "Customise how 媒灵 looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether 媒灵 follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how 媒灵 is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when 媒灵 launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of 媒灵.",
