export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von 媒灵",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von 媒灵 wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
