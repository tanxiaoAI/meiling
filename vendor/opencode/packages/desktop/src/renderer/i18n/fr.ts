export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'媒灵",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'媒灵 a été téléchargée. Voulez-vous l'installer et redémarrer ?",
