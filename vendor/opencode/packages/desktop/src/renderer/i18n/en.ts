export const dict = {
  ...
  "desktop.updater.none.message": "You are already using the latest version of 媒灵",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of 媒灵 has been downloaded, would you like to install it and relaunch?",
